...
class oe {
  ...
  async cachePut(e, t) {
    ...
    if (!r)
      return !1;
    const { cacheName: i, matchOptions: c } = this._strategy, o = await self.caches.open(i), h = this.hasCallback("cacheDidUpdate"), g = h ? await ae(
...
class N {
  ...
  handleAll(e) {
    ...
    const t = e.event, n = typeof e.request == "string" ? new Request(e.request) : e.request, a = "params" in e ? e.params : void 0, r = new oe(this, { event: t, request: n, params: a }), i = this._getResponse(r, n, t), c = this._awaitComplete(i, r, n, t);
    return [i, c];
  }
...
class he {
  ...
  addToCacheList(e) {
    ...
    for (const n of e) {
      ...
      const { cacheKey: a, url: r } = Y(n), i = typeof n != "string" && n.revision ? "reload" : "default";
...
class be extends N {
   ...
   */
  constructor(e = {}) {
    super(e), this.plugins.some((t) => "cacheWillUpdate" in t) || this.plugins.unshift(Re), this._networkTimeoutSeconds = e.networkTimeoutSeconds || 0;
  }
  /**
   * @private
   * @param {Request|string} request A request to run this strategy for.
...
const V = /* @__PURE__ */ new WeakMap(), k = /* @__PURE__ */ new WeakMap(), $ = /* @__PURE__ */ new WeakMap(), L = /* @__PURE__ */ new WeakMap(), M = /* @__PURE__ */ new WeakMap();
function De(s) {
...
function ke(s) {
  return typeof s == "function" ? Ue(s) : (s instanceof IDBTransaction && Le(s), Ce(s, xe()) ? new Proxy(s, P) : s);
}
function f(s) {
...
const T = (s) => M.get(s);
function Pe(s, e, { blocked: t, upgrade: n, blocking: a, terminated: r } = {}) {
...
const Ie = ["get", "getKey", "getAll", "getAllKeys", "count"], Me = ["put", "add", "delete", "clear"], U = /* @__PURE__ */ new Map();
function W(s, e) {
  ...
  if (
    ...
    !(t in (n ? IDBIndex : IDBObjectStore).prototype) || !(a || Ie.includes(t))
  )
    return;
...
const ve = "workbox-expiration", y = "cache-entries", B = (s) => {
...
class Ke {
   ...
   */
  async getDb() {
    return this._db || (this._db = await Pe(ve, 1, {
...
class Q {
  ...
  _getCacheExpiration(e) {
    ...
    return t || (t = new Ae(e, this._config), this._cacheExpirations.set(e, t)), t;
  }
  /**
...
ye([{"revision":null,"url":"assets/index-CUcrAHke.css"},{"revision":null,"url":"assets/index-DZ5hfYgC.js"},{"revision":"25f07272034f49eb4afffd38b37b5e71","url":"index.html"},{"revision":"d933c406a47e86ef7e0ddc356024a64e","url":"registerSW.js"},{"revision":"e5834768cb68c64ae4734a87edee45ae","url":"pwa-192x192.png"},{"revision":"1df6e708b1c929084cadb64cdc0cbc91","url":"pwa-512x512.png"},{"revision":"3c247ee27cdc1b71a83869939afb2502","url":"manifest.webmanifest"}]);
I(
  ({ request: s }) => s.destination === "image" || s.destination === "video",
  new _e({
...
I(
  ({ url: s }) => s.origin === "https://fepasapptest.github.io",
  new be({
